...
let BooksService = class BooksService {
    ...
    async bookReserved(id) {
        const book = await this.findOne(id);
        if (book.isReserved) {
            throw new common_1.ConflictException('This Book is already reserved');
        }
    ...
    async deleteReservation(id) {
        const book = await this.findOne(id);
        if (!book.isReserved) {
            throw new common_1.ConflictException('This Book now is not reserved');
        }
